                ...
                <div className={`flex gap-5 ${category === 'live' ? 'items-start' : 'items-baseline'}`}>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="leading-tight">
                      ...
                      <span className="text-[10px] ml-1 px-1 py-0.5" style={{ color: '#828282', border: '1px solid #ff660040', borderRadius: '3px' }}>
                      ...
                      {article.summary && category === 'live' && (
                        <div className="mt-1 text-xs text-[#444] leading-relaxed line-clamp-2"
